...
for i = 1:numel(sub)
    ...
    %-----------------------------------------------------------------------
    % Job saved on 16-Jul-2024 18:36:17 by cfg_util (rev $Rev: 8183 $)
    % spm SPM - SPM12 (dev)
    % cfg_basicio BasicIO - Unknown
    %-----------------------------------------------------------------------

    %% realignment
    matlabbatch{1}.spm.spatial.realign.estwrite.data = {{'/Users/oj/Desktop/pre_BIDS/BIDS_RBD/sub-01/func/sub-01_task-BRAINMRINONCONTRASTDIFFUSION_acq-AxialfMRIrest_bold.nii'}};
